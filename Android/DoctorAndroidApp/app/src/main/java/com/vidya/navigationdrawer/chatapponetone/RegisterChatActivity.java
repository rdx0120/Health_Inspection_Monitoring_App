...
public class RegisterChatActivity extends AppCompatActivity {
       ...
       // getSupportActionBar().setTitle("Register");
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //String txt_username ="a";// username.getText().toString();
                //String txt_email = "ningesh1406@gmail.com";//email.getText().toString();
                //String txt_password ="123456";// password.getText().toString();

                Utils.hideKeyboard(RegisterChatActivity.this);
    ...
    private void register(final String username, String email, String password){
        ...
        dialog = Utils.showLoader(RegisterChatActivity.this);
...
//                        String abv=task.getException().getMessage();
                       // System.out.print(abv);
                        if (task.isSuccessful()){
                            ...
                            hashMap.put("username", "Doctor: "+username);
                            ...
                            Toast.makeText(RegisterChatActivity.this, "You can't register woth this email or password", Toast.LENGTH_SHORT).show();
                            if(dialog!=null){
                                dialog.dismiss();
                            }
                        }
