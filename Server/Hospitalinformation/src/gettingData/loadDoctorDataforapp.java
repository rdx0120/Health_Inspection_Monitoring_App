...
/**
 * Servlet implementation class loadDoctorDataforapp
 */
@WebServlet("/loadDoctorDataforapp")
public class loadDoctorDataforapp extends HttpServlet {
	...
	public  ArrayList<Book> getAllCountries( String username ) {
	     //connection = con;
	        ...
	        String sql = "select * from doctorsdetails where doctorname='"+username+"'";
